...
namespace Photo.Net.Base.Infomation
{
    ...
    public static class Processor
    {
        ...
        static Processor()
        {
            _logicalCpuCount = ConcreteLogicalCpuCount;
        }
        ...
        private static ProcessorArchitecture Convert(ushort wProcessorArchitecture)
        {
            ...
            switch (wProcessorArchitecture)
            {
                ...
                case NativeConstants.PROCESSOR_ARCHITECTURE_UNKNOWN:
                    platform = ProcessorArchitecture.None;
                    break;
            }
