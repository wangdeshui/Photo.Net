    ...
    public sealed class Selection
    {
        ...
        private class Data
            : ICloneable,
              IDisposable
        {
            public GeometryGraphicsPath basePath;
            public GeometryGraphicsPath continuation;
        ...
        //private GeometryGraphicsPath cachedPathTrue;
        //private GeometryGraphicsPath cachedPathFalse;
        ...
        /*
        public GeometryGraphicsPath GetPathReadOnly()
        {
        ...
        /*
        public GeometryGraphicsPath GetPathReadOnly(bool applyInterimTransform)
        {
            lock (this.syncRoot)
            {
        ...
        public GeometryGraphicsPath CreatePath()
        {
        ...
        public void Reset()
        {
            lock (this.syncRoot)
            {
                ...
                this.data.basePath = new GeometryGraphicsPath();
                this.data.continuation.Dispose();
                this.data.continuation = new GeometryGraphicsPath();
