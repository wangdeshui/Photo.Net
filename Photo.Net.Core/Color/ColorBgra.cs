...
namespace Photo.Net.Core.Color
{
    ...
    public struct ColorBgra
    {
        ...
        {
            var color = new ColorBgra { Bgra = BgraToUInt32(b, g, r, a) };
            return color;
        }
        ...
        /// </summary>
        public static ColorBgra FromColor(System.Drawing.Color c)
        {
        ...
        {
            var caA = (uint)Utility.FastScaleByteByByte((byte)(255 - cbAlpha), ca.A);
            var cbA = (uint)Utility.FastScaleByteByByte(cbAlpha, cb.A);
            uint cbAT = caA + cbA;
        ...
        public static ColorBgra Lerp(ColorBgra from, ColorBgra to, float frac)
        {
            ...
            {
                B = Utility.ClampToByte(Utility.Lerp(@from.B, to.B, frac)),
                G = Utility.ClampToByte(Utility.Lerp(@from.G, to.G, frac)),
                R = Utility.ClampToByte(Utility.Lerp(@from.R, to.R, frac)),
                A = Utility.ClampToByte(Utility.Lerp(@from.A, to.A, frac))
            };
        ...
        /// </remarks>
        public static ColorBgra BlendColors4W16IP(ColorBgra c1, uint w1, ColorBgra c2, uint w2, ColorBgra c3, uint w3,
            ColorBgra c4, uint w4)
        {
            const uint ww = 32768;
            ...
            else
            {
                b =
                    (uint)
                        ((((long)c1.A * c1.B * w1) + ((long)c2.A * c2.B * w2) + ((long)c3.A * c3.B * w3) + ((long)c4.A * c4.B * w4)) /
                         af);
                g =
                    (uint)
                        ((((long)c1.A * c1.G * w1) + ((long)c2.A * c2.G * w2) + ((long)c3.A * c3.G * w3) + ((long)c4.A * c4.G * w4)) /
                         af);
                r =
                    (uint)
                        ((((long)c1.A * c1.R * w1) + ((long)c2.A * c2.R * w2) + ((long)c3.A * c3.R * w3) + ((long)c4.A * c4.R * w4)) /
                         af);
            }
        ...
        public static ColorBgra BlendColorsWAIP(ColorBgra[] c, uint[] w)
        {
            ...
            return FromUInt32((uint)b + ((uint)g << 8) + ((uint)r << 16) + ((uint)a << 24));
        }
