...
{
    /// <summary>
    /// Provides a set of standard UnaryPixelOperations, there just work with one pixel
    /// </summary>
    public sealed class UnaryPixelOperations
    {
        private UnaryPixelOperations()
        {
        }
              ...
              ICloneable
        {
            ...
            public void SetGamma(int index, float val)
            {
                ...
                gamma[index] = val.Clamp(0.1f, 10.0f);
                UpdateLookupTable();
            }
