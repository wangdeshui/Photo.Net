...
namespace Photo.Net.Gdi.Graphic
{
    ...
    /// </summary>
    public static class PtnGraphics
    {
        ...
        {
            var pi2 = new ImageMetadata(0, 0, 0, new byte[0]);
        ...
        public static PropertyItem ClonePropertyItem(PropertyItem pi)
        {
            ...
            var pi2 = new ImageMetadata(pi.Id, pi.Len, pi.Type, valueClone);
            return pi2.ToPropertyItem();
        }
        ...
        {
            ImageMetadata pi2 = ImageMetadata.FromBlob(piBlob);
            return pi2.ToPropertyItem();
        }
        ...
        {
            using (var nullGraphics = new NullGraphics())
            {
