...
namespace Photo.Net.Gdi.Renders
{
        ...
        : CanvasControl
    {
        ...
        private RectangleF GetOurRectangle()
        {
            ...
            float ourWidth = UserInterface.ScaleWidth(this.Size.Width);
            float ourHeight = UserInterface.ScaleHeight(this.Size.Height);
        ...
        protected override void OnRender(Graphics g, Point offset)
        {
            lock (this)
            {
                float ourSize = UserInterface.ScaleWidth(Math.Min(Width, Height));
        ...
        public MoveNubRenderer(SurfaceBoxRenderList ownerList)
            : base(ownerList)
        {
