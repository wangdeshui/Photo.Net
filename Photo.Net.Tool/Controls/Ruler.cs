        ...
        : UserControl
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (this.orientation == Orientation.Horizontal)
            {
                ...
                //                e.Graphics.DrawString(abbString, Font, SystemBrushes.WindowText, UserInterface.ScaleWidth(-2), 0);
                e.Graphics.DrawString("", Font, SystemBrushes.WindowText, UserInterface.ScaleWidth(-2), 0);
            }
            ...
            if (this.orientation == Orientation.Horizontal)
            {
                clipRegion.Exclude(new Rectangle(0, 0, UserInterface.ScaleWidth(16), ClientRectangle.Height));
            }
            ...
            if (this.orientation == Orientation.Horizontal)
            {
                clipRegion.Exclude(new Rectangle(0, 0, UserInterface.ScaleWidth(16), ClientRectangle.Height - 1));
            }
