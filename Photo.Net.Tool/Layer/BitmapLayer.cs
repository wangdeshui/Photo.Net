...
namespace Photo.Net.Tool.Layer
{
    [Serializable]
          ...
          IDeserializationCallback
    {
        ...
        protected unsafe override void RenderImpl(RenderArgs args, Rectangle roi)
        {
            ...
            {
                ColorBgra* dstPtr = args.Surface.UnsafeGetPointAddress(roi.Left, y);
                ColorBgra* srcPtr = this.surface.UnsafeGetPointAddress(roi.Left, y);
        ...
        public override BaseWindow CreateConfigDialog()
        {
