...
{
    /// <summary>
    /// A few utility functions specific to get infomation about Photo.net
    /// </summary>
    public static class PtnInfo
    {
        ...
        {
            object[] attributes = typeof(PtnInfo).Assembly.GetCustomAttributes(typeof(AssemblyConfigurationAttribute), false);
        ...
        public static DateTime ExpirationDate
        {
            get
            {
                if (PtnInfo.IsFinalBuild && !IsDebugBuild)
                {
                    return DateTime.MaxValue;
                }
                else
                {
                    return PtnInfo.BuildTime + new TimeSpan(BetaExpireTimeDays, 0, 0, 0);
                }
            }
        }
        ...
        public static bool IsExpired
        {
            get
            {
                ...
                {
                    if (DateTime.Now > PtnInfo.ExpirationDate)
                    {
                        return true;
                    }
                }
