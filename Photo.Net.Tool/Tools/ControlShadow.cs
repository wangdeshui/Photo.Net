...
namespace Photo.Net.Tool.Window
{
    public sealed class ControlShadow
        : Control
    {
        private readonly Image _roundedEdgeUl = null;
        private readonly Image _roundedEdgeUr = null;
        private readonly Image _roundedEdgeLl = null;
        private readonly Image _roundedEdgeLr = null;
        ...
        public ControlShadow()
        {
            ...
            if (!PtnInfo.IsFinalBuild && !betaTagDone)
            {
                betaTagDone = true;

                //                string betaTagStringFormat = PdnResources.GetString("ControlShadow.BetaTag.Text.Format");
                //                string appName = PtnInfo.GetFullAppName();
                //                string expiredDateString = PtnInfo.ExpirationDate.ToShortDateString();
