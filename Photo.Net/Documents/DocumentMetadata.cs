...
namespace Photo.Net.Documents
{
    ...
    public class DocumentMetadata
    {
        ...
        private readonly Hashtable _exifIdToExifInfo = new Hashtable(); // maps short -> ExifInfo
        ...
        {
            ExifInfo info = (ExifInfo)this._exifIdToExifInfo[id];
        ...
        public void RemoveExifValues(short id)
        {
            ...
            if (info != null)
            {
                ...
                this._exifIdToExifInfo.Remove(idObj);
            }
        ...
        {
            SetValue(DocumentMetadata.UserSectionName, name, value);
        }
        ...
        public void ReplaceWithDataFrom(DocumentMetadata source)
        {
            OnChanging();
            ++suppressChangeEvents;
        ...
        internal DocumentMetadata(NameValueCollection userMetaData)
        {
