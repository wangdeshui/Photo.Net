...
namespace Photo.Net.Layer
{
    ...
    /// </summary>
    [Serializable]
    public sealed class ImageLayerList
        : ArrayList
    {
        private readonly Documents.Document _parent;
        ...
        public ImageLayerList(Documents.Document parent)
        {
            this._parent = parent;
        }
        ...
        */
        ...
        public ImageLayer GetAt(int index)
        {
            return (ImageLayer)this[index];
        }
